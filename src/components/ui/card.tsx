  ...
  "rounded-2xl border transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        kitten: "bg-gradient-to-b from-card to-[hsl(38,60%,97%)] shadow-lg hover:shadow-xl hover:-translate-y-1",
        feature: "bg-gradient-to-br from-card to-secondary shadow-sm border-0",
      },
    },
    defaultVariants: {
      variant: "default",
